return {
  {
    ...
    config = function()
      ...
      local config_group = {
        type = "group",
        val = {
          dashboard.button("c", "[c] Open init.lua", ":e $MYVIMRC<CR>"),
          dashboard.button(
            "v",
            "[v] Find in config",
      ...
      local system_group = {
        ...
        val = {
          ...
          dashboard.button("m", "[m] Update Mason", ":Mason<CR>"),
          dashboard.button("h", "[h] CheckHealth", ":checkhealth<CR>"),
        },
        opts = { spacing = 1 },
      }
      local docs_group = {
        type = "group",
        val = {
          dashboard.button("d", "[d] Help", ":Telescope help_tags<CR>"),
