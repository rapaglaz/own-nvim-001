...
function M.setup_lsp_keymaps(bufnr)
    ...
    -- Navigation
    -- gd/gD have no nvim default; gri/grr/grt/grn/gra are nvim 0.10-0.12 defaults (not remapped)
    ...
    -- Actions (leader aliases for which-key discoverability)
    ...
    -- Information
    -- K (hover) is nvim 0.10+ default — not remapped here
    ...
    -- Inlay hints (vim.lsp.inlay_hint always available since nvim 0.10)
